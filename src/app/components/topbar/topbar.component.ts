...
export class TopbarComponent implements OnInit, OnDestroy {
  ...
  hideSearch(): boolean {
    return this.router.url.includes('radio') || this.router.url.includes('podcast')
    || this.router.url.includes('news') || this.router.url.includes('news') || this.router.url.includes('playlist');
  }
